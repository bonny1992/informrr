...
You can find the image on Docker Hub [here](https://hub.docker.com/repository/docker/bonny1992/sonarr-radarr-notification-aggregator)
...
4. That's it, you can configure the webhook in Sonarr and Radarr with tye url you will find in you `/some/folder/to/store/your/data` folder in the file `url.txt`.
